...
var methods = {
	...
	openAsset: function(index){
		...
		if(asset.isVideo || asset.isAudio){
			var autoplay = '';
			helpers.filePreview.innerHTML = '<video id="preview-video" controls poster='+ asset.thumbUrl +' class="view-file-video"><source src='+ asset.h264StreamUrl +' type="video/mp4"></video>';
